...
# التنسيق البصري الاحترافي (خط 20، أسود، جدول مخطط)
st.markdown("""
    <style>
...
try:
    # تعديل طريقة جلب البيانات لتكون أكثر مرونة (تستخدم 5m إذا فشل الـ 1m)
    ...
    with col_leg:
        st.markdown('<div style="border:3px solid black; padding:10px;"><h5>دليل القناص</h5>✅ ممتازة<br>⚠️ عكس التيار<br>⚡ استباق</div>', unsafe_allow_html=True)
    ...
    st.error(f"يرجى إعادة تشغيل التطبيق.. خطأ في الاتصال: {e}")
